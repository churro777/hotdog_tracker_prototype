...
interface UseDataServiceReturn {
  ...
  updatePost: (id: string, updates: Partial<ContestPost>) => Promise<ContestPost | null>
  deletePost: (id: string) => Promise<boolean>
  updateUser: (id: string, updates: Partial<ContestUser>) => Promise<ContestUser | null>
...
export function useDataService(): UseDataServiceReturn {
   ...
   * Add a new post
   */
  const addPost = useCallback(async (postData: Omit<ContestPost, 'id'>): Promise<ContestPost | null> => {
    try {
   ...
   */
  const updatePost = useCallback(async (id: string, updates: Partial<ContestPost>): Promise<ContestPost | null> => {
    try {
   ...
   */
  const updateUser = useCallback(async (id: string, updates: Partial<ContestUser>): Promise<ContestUser | null> => {
    try {
   ...
   * Add a new user
   */
  const addUser = useCallback(async (userData: Omit<ContestUser, 'id'>): Promise<ContestUser | null> => {
    try {
